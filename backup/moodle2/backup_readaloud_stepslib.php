...
class backup_readaloud_activity_structure_step extends backup_activity_structure_step {
    ...
    protected function define_structure() {
        ...
        $oneactivity = new backup_nested_element(constants::M_MODNAME, array('id'), array(
                ...
                'usecorpus', 'corpushash', 'passagepicture', 'passagekey', 'corpusrange', 'customfont', "stdashboardid", 'timecreated',  'timemodified',
                'viewstart', 'viewend', 'showqtitles', 'showqreview', 'qfinishscreen', 'qcustomscreen', 'steps', 'quizreattempt', 'readreattempt',
        ));
