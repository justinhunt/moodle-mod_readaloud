...
$string['optionalprepsteps'] = 'Optional practice steps';
$string['optionalprepsteps_details'] = 'Listen, and practice steps are optional';
$string['optionalprepsteps_help'] = 'If checked, students do not have to complete the listen and practice steps before moving on. Those steps stay open, the read step is open straight away, and only the read and quiz steps (if enabled) must be completed in order. Opening the listen or practice step counts as completing it.';
...
$string['resultsnotready'] = 'Your reading could not be evaluated. Please try reading again.';
$string['timeremaining'] = 'Time remaining';
$string['streamingread'] = 'Realtime transcription steps';
$string['streamingread_details'] = 'Which activity steps use realtime transcription. In those steps the student records in the page and the transcript arrives as they speak, so results appear immediately instead of after a wait. Steps not listed here use the pop up cloud recorder, which uploads the recording and transcribes it afterwards.';
$string['realtimesteps_practice'] = 'Practice step';
$string['realtimesteps_practiceread'] = 'Practice and read steps';
$string['alternatestreaming'] = 'Realtime transcription';
$string['alternatestreaming_details'] = 'By default realtime transcription will use browser based transcription, which is the fastest though it is not always available. If it is not available it will use 3rd party (Cloud Poodll or Azure). Choose 3rd party to never use browser based transcription. Realtime transcription will only be used if the transcriber is set to Open STT.';
$string['realtime_auto'] = 'Auto';
$string['realtime_thirdparty'] = '3rd party';
...
$string['welldone_desc'] = 'You pronounced the words correctly!';
