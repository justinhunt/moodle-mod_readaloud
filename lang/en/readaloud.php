...
$string['optionalprepsteps_details'] = 'Listen, practice and shadow steps are optional';
$string['optionalprepsteps_help'] = 'If checked, students do not have to complete the listen, practice and shadow steps before moving on. Those steps stay open, the read step is open straight away, and only the read and quiz steps (if enabled) must be completed in order. Opening the listen or practice step counts as completing it. This is handy for demonstrations.';
...
$string['streamingread'] = 'Stream the reading step';
$string['streamingread_details'] = 'Replaces the pop up cloud recorder in the reading step with an in page recorder that transcribes as the student reads. Results appear immediately instead of after a wait. Only applies to activities using the Open STT passage transcriber; activities using Guided STT keep the existing recorder.';
