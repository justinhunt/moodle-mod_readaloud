...
$string['gradesadmininstructions']='On this page you can edit the alternatives for the passage while viewing a summary of the mistranscriptions. When you save, all the attempts will be re-evaluated. If you have enabled machine grading you can also push the adjusted grades to the gradebook.';
