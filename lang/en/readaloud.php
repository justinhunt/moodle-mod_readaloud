...
$string['readaloud:manageattempts'] = 'Can manage attempts';
$string['id']='ID';
$string['name']='Name';
...
$string['enabletts_details'] = 'Words marked as errors, when clicked will play back the correct pronunciation via a TTS service.';
