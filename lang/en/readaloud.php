...
$string['stricttranscribe'] = 'Read step transcriber';
...
$string['streamingread'] = 'Open STT realtime steps';
$string['streamingread_details'] = 'When using Open STT this determines which steps use realtime transcription. In those steps the transcription is streamed and arrives as the students speak, so results appear immediately instead of after a wait. Steps not listed here use the older async system, which uploads the recording and transcribes it afterwards.';
$string['realtimesteps_practice'] = 'Practice step only';
$string['realtimesteps_practiceread'] = 'Practice and read steps';
$string['alternatestreaming'] = 'Open STT realtime';
$string['alternatestreaming_details'] = 'If set to \'Auto\' realtime transcription will use browser based transcription if it is available, and fall back to 3rd party (Cloud Poodll or Azure) services if not. Choose 3rd party if browser based is not working well for you.';
...
$string['transcriber'] = 'Practice step transcriber';
...
$string['video'] = 'Video';
$string['miscelleneous'] = "Miscelleneous";
