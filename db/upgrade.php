...
function xmldb_readaloud_upgrade($oldversion) {
    ...
    // for demonstrative purposes and to show how the readaloud
    // iself has been upgraded.

    // For each upgrade block, the file readaloud/version.php
    ...
    if ($oldversion < 2007040100) {
        ...
        // Define field course to be added to readaloud
        ...
        // Define field intro to be added to readaloud
        $table = new xmldb_table('readaloud');
        ...
        upgrade_mod_savepoint(true, 2007040100, 'readaloud');
    }
    ...
    if ($oldversion < 2007040101) {
        ...
        // Define field timecreated to be added to readaloud
        $table = new xmldb_table('readaloud');
        ...
        // Define field timemodified to be added to readaloud
        $table = new xmldb_table('readaloud');
        ...
        // Define index course (not unique) to be added to readaloud
        $table = new xmldb_table('readaloud');
        ...
        upgrade_mod_savepoint(true, 2007040101, 'readaloud');
    }
    ...
    if ($oldversion < 2007040200) {
        ...
        upgrade_mod_savepoint(true, 2007040200, 'readaloud');
    }
