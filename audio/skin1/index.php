...
?>
	...
	echo fetchRecorder("","poodllcallback" ,"p1","p2","p3","p4","therecorderid","false", "plain");
 }else{ 
	echo fetchRecorder("","poodllcallback" ,"p1","p2","p3","p4","therecorderid","false", "plain");
?>
	<br /><button style="width:180px;height:40px" name="export" id="id_export" onclick="doexport('therecorderid');">submit</button>
<?php } ?> 
</td><td>
</td></tr></table>
<div id="players" />
