...
if ($hassiteconfig) {
    ...
    $readaloudcat = new admin_category(
        'modsettingsreadaloudcat',
    ...
    $mainsettings->add(new admin_setting_configselect(
        ...
        get_string('awsregion_details', constants::M_COMPONENT),
        'useast1',
        $regions
    ));
    ...
    $mainsettings->add(new admin_setting_configselect(
        constants::M_COMPONENT . '/expiredays',
    ...
    $mainsettings->add(new admin_setting_configcheckbox(
        constants::M_COMPONENT . '/allowearlyexit',
        get_string('allowearlyexit', constants::M_COMPONENT),
        get_string('allowearlyexit_defaultdetails', constants::M_COMPONENT),
        1
    ));
    ...
    $mainsettings->add(new admin_setting_configmulticheckbox(
        constants::M_COMPONENT . '/activitysteps',
        get_string('activitysteps', constants::M_COMPONENT),
        get_string('activitystepsdetails', constants::M_COMPONENT),
        $stepdefaults,
        $stepoptions
    ));
    ...
    $mainsettings->add(new admin_setting_configselect(
        ...
        get_string('defaultrecorder_details', constants::M_COMPONENT),
        constants::REC_ONCE,
        $recoptions
    ));
